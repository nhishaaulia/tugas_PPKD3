      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color.fromARGB(255, 78, 100, 110),
                    width: 3,
                  ),
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      width: 200,
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 155, 185, 211),
                        border: Border.all(
                          color: const Color.fromARGB(255, 78, 100, 110),
                          width: 3,
                        ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      width: 20,
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 151, 137, 192),
                        border: Border.all(
                          color: const Color.fromARGB(255, 78, 100, 110),
                          width: 3,
                        ),
            ...
            Center(
              child: Text("Deskripsi Profil", style: TextStyle(fontSize: 16)),
            ),
